...
Rendering of retro-reflective materials is useful in a variety of contexts. For security garnments and signs, retroreflective appearances are heavily used. \todo{Different usage and forms} We known for measurements that retro-reflective tapes exhibit an imperfect (rough) retro-reflective lobe~\cite{BelcourBackvector}.
