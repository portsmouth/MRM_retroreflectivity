...
\begin{figure}[!b]
  \begin{center}
    \includegraphics[width=0.95\textwidth]{figures/data_fit.png}
  \end{center}
  \caption{Measured BRDF of retro-reflective tape (blue) at three different light source angles $\theta_L \in \{15^\circ, 30^\circ, 60^\circ\}$, and the MRM model fit (red).}
  \label{fig:data_fit}
\end{figure}
