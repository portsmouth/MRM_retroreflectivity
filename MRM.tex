...
$\rho_{r, \text{MRM}}(\vecv) + \rho_{t, \text{MRM}}(\vecv) \leq 1$ for all $\vecv$.
For the directional albedos we simply have (where $\Omega_{\vecx}$ denotes the hemisphere containing $\vecx$):
\begin{eqnarray}
  \begin{split}
  \rho_{r, \text{MRM}}(\vecv) =
